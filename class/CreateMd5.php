 ...
 * @Last Modified time: 2018-12-17 22:58:45
...
class CreateMd5
{
     ...
     */
    public function scanFilelist($dir = '')
    {
     ...
     */
    public function addMd5toList($dir, $file)
    {
        $this->file_list[]    = $file;
